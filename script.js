...
// let idNode = parseInt(textElement.dataset.idNode);
// let idData = textElement.dataset.idNode;
// console.log(idData);
// console.log(idNode);
...
// function getDataIdFromId(textNodeID){
//   const textNode = JSON.find(textNode => textNode.id === textNodeID)
//   idNode == textNode
...
// console.log(getNodeFromId(idNode).id);
// console.log(getNodeFromId(idNode));

// function getHTMLThatIdNode(){
//   idData.setAttribute(dataIdNode, getNodeFromId(idNode).id)
// }
// getHTMLThatIdNode()
...
function showTextNode(textNodeIndex) {
  ...
  // idDataNode = textNode.id
  setIDNode(textNode.id)
  // textElement.setAttribute('data-id-node', textNode.id)
  // console.log(textNode.id);
  // getNodeFromId(idNode)
  // console.log(getNodeFromId(idNode).text);
