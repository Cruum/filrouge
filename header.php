    ...
    //                     src="graphique-vectoriel-de-l-élément-silhouette-hydra-monstre-illustration-d-un-design-la-isolée-sur-le-fond-blanc-204621519 1.png"
    //                     alt=""> </a> -->
    //             <li class="test"><a class="nav_lnk" href="Filrouge.html">
    ...
    //             <li class="test"><a class="nav_lnk" href="#" id="principal">
    ...
    //                             <li class="menu-itm"><a class="li_lnk menulnk" href=""> Jouer</a></li>
    //                             <li class="menu-itm"><a class="li_lnk menulnk" href=""> Créer </a></li>
    //                             <li class="menu-itm"><a class="li_lnk menulnk" href="">Modifier</a></li>
    //                         </ul>
    //                     <!-- </nav> -->
    //                 </div>
    //             </li>
    ...
    //             <li class="test"><a class="nav_lnk" href="dashboard.html">
    ...
    //                 </a></li>
    //             <li class="test"><a class="nav_lnk" href="connexion.html">
...
<!-- --------------------------------------------------------- -->
<!-- bloc présentation histoire page principale -->

<?php 
        echo  '  <article class="history-contenaire">
                <div class="history contenaire">
                    <img class="history-img" src="img/vallee_des_dieux_illustrationc_anato_finnstark-ld 1.png"
                        alt="image fantastique dun grand arbre">
            ...
            <article class="history-contenaire">
                <div class="history contenaire contenaire-dimension">
                    <a class="history-lnk" href="#"><img class="history-img"
                            ...
                            alt="image fantastique dun grand arbre"></a>
                    <a href="filrougejdr.html">
                        <h2 class="history-tlt"> Réincartaysie</h2>
                    </a>
                    <h3 class="history-theme"> Fantasy</h3>
                    <p class="history-resume">Réincarne toi dans un monde de fantasy et voit où tes choix te conduiront:
                        devient roi du monde ou arriveras-tu à sortir de la forêt</p>
                    <a href="" class="history-button"> Commencer lhistoire </a>
                </div>
            </article> '
    ?>
...
<article class="history-contenaire">
                <div class="history contenaire contenaire-dimension">
                    ...
                    <p class="history-resume">Réincarne toi dans un monde de fantasy et voit où tes choix te conduiront:
                        devient roi du monde ou arriveras-tu à sortir de la forêt</p>
                    <div class="buttonMJ">
                        <button class="buttonplus"><i class="fa-regular fa-plus" style="color: #ffffff;"></i></button>
                        <button class="buttonplus"><i class="fa-sharp fa-solid fa-minus"></i> </button>
                    </div>
                </div>
            </article>
            '
...
<main class=" main-histoire">
        ...
        <section class="contenaire contenaire-history">
            <div class="contenaire-history-wrap"> 
                <img class="contenaire-history_img" src="img/actu-guides-prairies.jpg" alt="image dune vallée" id="img">
                <p class="history-txt" id="histoire">Vos paupières sont lourdes, vous fermez les yeux et au moment où
 ...
 <section class="section_choice" id="zone_choice">

 <div class="button-item display" id="div_button"><button class="choice-itm" id="choice1" href="#">Quallez-vous faire?</button> </div>

</section>

       
        <section id="nextHistorie" class="contenaire contenaire-history display">

        </section>
        <div id="choiceTwo" class="Choix contenaire">    </div>
    </main>'
